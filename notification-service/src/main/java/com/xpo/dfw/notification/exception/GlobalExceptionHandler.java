...
/**
 * Centralized exception handling for the Notification Service. Converts
 * domain exceptions and validation errors into a consistent
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleDeliveryFailure(NotificationDeliveryException ex, HttpServletRequest request) {
